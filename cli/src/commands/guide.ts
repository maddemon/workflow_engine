...
const workflowSchema = {
  ...
  node: {
    ...
    ports: 'PortInstance[] (optional, auto-filled by backend if omitted)',
    positionX: 'number | null (optional, auto-arranged by backend if omitted)',
    positionY: 'number | null (optional, auto-arranged by backend if omitted)',
    isEntry: 'boolean (optional, auto-derived as first Trigger node; can override)',
  ...
  connection: {
    ...
    sourcePortName: 'string | null (optional, defaults to first Output port)',
    targetNodeId: 'string (required)',
    targetPortName: 'string | null (optional, defaults to first Input port)',
