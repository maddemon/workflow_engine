...
public sealed class WorkflowSchedulerKernel
{
        ...
        IServiceProvider serviceProvider = null!)
    {
        ...
        _nodeProcessor = new NodeProcessor(nodeRegistry, contextFactory, secretMasker, _retryExecutor, _outputRouter, _defaults, httpExecutionService, serviceProvider: serviceProvider);
