        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<Guid>(type: "TEXT", nullable: true, comment: "项目 ID"),
                    Name = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false, comment: "工作流名称"),
                    CreatedBy = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false, comment: "创建人"),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false, comment: "是否激活"),
                    StyleSettingsJson = table.Column<string>(type: "TEXT", nullable: true, comment: "样式设置"),
