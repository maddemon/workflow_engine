...
export const statusConfig: Record<ExecutionStatus, { color: string; icon: React.ReactNode; labelKey: string }> = {
  ...
  Compensating: { color: 'yellow', icon: <Loader size={14} speed={2} />, labelKey: 'status.running' },
  Compensated: { color: 'teal', icon: <Check size={14} strokeWidth={3} />, labelKey: 'status.completed' },
  CompensationFailed: { color: 'red', icon: <X size={14} strokeWidth={3} />, labelKey: 'status.failed' },
