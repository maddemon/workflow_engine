...
const statusConfig: Record<ExecutionStatus, { color: string; icon: React.ReactNode; labelKey: string }> = {
  ...
  Compensating: { color: 'yellow', icon: <Loader size={12} speed={2} />, labelKey: 'status.running' },
  Compensated: { color: 'teal', icon: <Check size={12} strokeWidth={3} />, labelKey: 'status.success' },
  CompensationFailed: { color: 'red', icon: <X size={12} strokeWidth={3} />, labelKey: 'status.failed' },
  DryRunCompleted: { color: 'green', icon: <Check size={12} strokeWidth={3} />, labelKey: 'status.success' },
