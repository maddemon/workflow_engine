...
| 2026-07-12 | Agent | 细化「阶段一：MCP Server 暴露」为 AI-native 切片：C# Host `/mcp` Streamable HTTP 为主、stdio 垫片兜底；工具面 = Catalog(2)+Workflow(7)，复用 task-010 能力；MCP Client 节点 / ToolCollection 仍属后续阶段 | task-011-ai-native-mcp-server |
